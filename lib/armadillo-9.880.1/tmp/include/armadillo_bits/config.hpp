...
#define ARMA_SUPERLU_INCLUDE_DIR /usr/include/superlu/
...
#define ARMA_AUX_LIBS /usr/lib/x86_64-linux-gnu/libopenblas.so;/usr/lib/x86_64-linux-gnu/liblapack.so;/usr/lib/x86_64-linux-gnu/libarpack.so;/usr/lib/x86_64-linux-gnu/libsuperlu.so
